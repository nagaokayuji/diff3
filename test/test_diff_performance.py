...
class TestDiffPerformance(unittest.TestCase):
    ...
    def test_large_diff_performance(self):
        ...
        large_seq1 = [str_a]*500 + [str_b]*500 + [str_c]*500 + [str_a]*500
        large_seq2 = [str_a]*500 + [str_c]*500 + [str_b]*500 + [str_a]*500
        ...
        self.assertLess(duration, 5, "Performance test took too long")
